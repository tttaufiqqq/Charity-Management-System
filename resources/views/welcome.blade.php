                    ...
                    @elseif(auth()->user()->hasRole('admin'))
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-8">
                            <div class="flex items-center justify-between mb-6">
                                <div>
                                    <h2 class="text-3xl font-bold text-gray-900">Welcome back, {{ auth()->user()->name }}!</h2>
                                    <p class="text-gray-600 mt-1">Manage and oversee CharityHub operations</p>
                                </div>
                            ...
                            <div class="grid md:grid-cols-4 gap-6 mb-8">
                                <div class="bg-yellow-50 p-6 rounded-lg">
                                    <p class="text-sm text-gray-600 mb-1">Pending Recipients</p>
                                    <p class="text-2xl font-bold text-gray-900">{{ \App\Models\Recipient::where('Status', 'Pending')->count() }}</p>
                                </div>
                                <div class="bg-green-50 p-6 rounded-lg">
                                    <p class="text-sm text-gray-600 mb-1">Approved Recipients</p>
                                    <p class="text-2xl font-bold text-gray-900">{{ \App\Models\Recipient::where('Status', 'Approved')->count() }}</p>
                                </div>
                                <div class="bg-blue-50 p-6 rounded-lg">
                                    <p class="text-sm text-gray-600 mb-1">Total Organizations</p>
                                    <p class="text-2xl font-bold text-gray-900">{{ \App\Models\Organization::count() }}</p>
                                </div>
                                <div class="bg-purple-50 p-6 rounded-lg">
                                    <p class="text-sm text-gray-600 mb-1">Active Campaigns</p>
                                    <p class="text-2xl font-bold text-gray-900">{{ \App\Models\Campaign::where('Status', 'Active')->count() }}</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex flex-wrap gap-3">
                                    ...
                                    <a href="{{ route('admin.campaigns.pending') }}" class="bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700 transition-colors">
                                        Pending Campaigns
                                    </a>
                                    <a href="{{ route('admin.events.pending') }}" class="bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700 transition-colors">
                                        Pending Events
                                    </a>
            ...
            @elseif(auth()->user()->hasRole('organizer'))
                ...
                <div class="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Campaign List with Allocate Button -->
                        @php
                            $activeCampaigns = auth()->user()->organization->campaigns()->where('Status', 'Active')->take(3)->get();
                        @endphp

                        @if($activeCampaigns->count() > 0)
                            <div class="mt-6 pt-6 border-t border-gray-200">
                                <h4 class="text-lg font-semibold text-gray-900 mb-4">Active Campaigns</h4>
                                <div class="space-y-3">
