...
<head>
    ...
    <title>Campaign Analytics - CharityHub</title>
...
<div class="min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('admin.analytics.donors') }}" class="text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">Donors</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-8">Donor Analytics</h1>
