        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('public.campaigns.browse') }}" class="text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">Campaigns</a>
                    ...
                    <a href="{{ route('public.recipients.index') }}" class="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">Recipients</a>
