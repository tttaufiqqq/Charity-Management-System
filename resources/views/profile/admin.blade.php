    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="text-white">
                        ...
                        <div class="flex items-center gap-2 mt-2">
                            ...
                            @if($user->email_verified_at)
                                <span class="inline-block px-3 py-1 bg-green-500/90 text-white rounded-full text-sm font-medium flex items-center gap-1">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <dl class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <dt class="text-xs font-semibold text-gray-500 uppercase mb-1">Email Verification</dt>
                    <dd class="text-base font-medium text-gray-900">
                        @if($user->email_verified_at)
